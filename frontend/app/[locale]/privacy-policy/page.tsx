    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-base text-black leading-relaxed mb-4">
            Additionally, we may automatically collect certain information when you access 
            or use our website, including:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li className="text-base text-black leading-relaxed">
              Usage data, such as pages visited, time spent on our platform, and referring 
              website.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-base text-black leading-relaxed mb-4">
            We may use your personal information for various purposes, including but not 
            limited to:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li className="text-base text-black leading-relaxed">
              Sending transactional emails, order updates, and customer support (you can 
              opt-out anytime).
            </li>
            <li className="text-base text-black leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-base text-black leading-relaxed">
            ...
            browsing activity on our devices. These technologies help us analyze usage 
            patterns, personalize content, remember your preferences, and measure 
            performance through your browser settings.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li className="text-base text-black leading-relaxed">
              Service providers who assist us in operating our business and delivering 
              services.
            </li>
            <li className="text-base text-black leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-base text-black leading-relaxed">
            Our services are not intended for individuals under the age of 18. If we become 
            aware that we have collected personal information from children without 
            parental consent, we will take prompt action to delete such data.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-2">
            ...
            <p className="text-base text-black leading-relaxed">
              Address: Storgothögen 12, 134 65 Stockholm
            </p>
          </div>
        </section>
      </div>
