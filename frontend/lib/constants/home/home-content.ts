export const homeContent = {
  hero: {
    ...
    cta: "Explore Now",
    description: "Browse our handpicked Sofa Sales collection featuring timeless sofas.",
  ...
  about: {
    ...
    description: "We are dedicated to delivering high-quality, thoughtfully designed sofas that merge comfort and style.",
    additionalText: "Our mission is to transform your living space into a sanctuary of relaxation and beauty, with products built to last.",
