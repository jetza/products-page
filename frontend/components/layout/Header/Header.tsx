...
import { SearchIcon, MenuIcon, BagIcon } from "@/components/ui/icons";
import { CartBadge } from "@/components/ui/Cart/CartBadge";
...
const Search = lazy(() =>
  import("@/components/ui/Search").then((m) => ({ default: m.Search }))
);
const CartDrawer = lazy(() =>
  import("@/components/ui/Cart/CartDrawer").then((m) => ({
...
export const Header = React.memo<HeaderProps>(
  ({ variant = "desktop", theme = "solid", className }) => {
    ...
    return (
      <header className={cn(bgClass, borderClass, className)}>
        ...
        {isSearchOpen && (
          <Suspense
            fallback={<div className="fixed inset-0 bg-black/50 z-40" />}
          >
            <Search
              variant="desktop"
              isOpen={isSearchOpen}
