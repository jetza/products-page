          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="lg:w-[60%] space-y-6">
              ...
              <p className="text-body text-gray-700 leading-relaxed">
                ...
                both beautiful and practical. Each sofa is crafted with
                attention to detail, carefully, medium, and timeless classics.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="lg:w-[60%] space-y-6">
              ...
              <p className="text-body text-gray-700 leading-relaxed">
                ...
                aesthetic. This collection exudes the essence of Scandinavian
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="lg:w-[60%] space-y-6">
              ...
              <p className="text-body text-gray-700 leading-relaxed">
                ...
                glamour sophistication, and unmatched warmth.
              </p>
            </div>
